 ...
 */
@Component
public class RestTemplateLowVerPlus {
    ...
    public <T> HttpResult<T> postForFormParams(String url, Object requestParam, Class<T> responseType) {
        return doPostForFormParams(url,requestParam,MediaType.parseMediaType("application/x-www-form-urlencoded;charset=GBK"),responseType);
    }
    /**
     * @author : tianxiaoyang
     * @date : 2020-03-25 14:22
    ...
    public <T> HttpResult<T> postForFormParamsUTF8(String url, Object requestParam, Class<T> responseType) {
        return doPostForFormParams(url,requestParam,MediaType.parseMediaType("application/x-www-form-urlencoded;charset=UTF-8"),responseType);
    }
    /**
     * @author : tianxiaoyang
     * @date : 2020-03-25 14:22
     ...
     **/
    public <T> HttpResult<T> doPostForFormParams(String url, Object requestParam, MediaType mediaType, Class<T> responseType) {
        try {
