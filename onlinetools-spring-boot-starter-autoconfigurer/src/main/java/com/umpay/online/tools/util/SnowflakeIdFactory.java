...
//        long time = id >> 22;
//        long milliseconds = time + 1288834974657L;
//        System.out.println("右移22："+milliseconds);


        DateTimeFormatter formatter=DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss SSS");

        LocalDateTime localDateTime = Instant.ofEpochMilli(1288834974657L).atZone(ZoneOffset.ofHours(8)).toLocalDateTime();
        System.out.println("生成时间："+formatter.format(localDateTime));
